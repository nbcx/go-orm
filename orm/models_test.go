...
type Post struct {
	...
	Tags             []*Tag    `orm:"rel(m2m);rel_through(github.com/nbcx/go-orm/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/nbcx/go-orm/orm.GroupPermissions)"`
}
...
var helpinfo = `need driver and source!
	...
	go Get -u github.com/nbcx/go-orm/orm
	...
	go test -v github.com/nbcx/go-orm/orm
